    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        {
            View view = hasViews.findViewById(id.chat_base_id_back);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ChatDetailActivity_.this.click();
                    }
        ...
        {
            View view = hasViews.findViewById(id.btnQuitQun);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        ChatDetailActivity_.this.onClickBtnQuitQun();
                    }
    ...
    @Override
    public void onPostExecuteQuitQun(final DelQunMemberResponse response) {
        handler_.post(new Runnable() {


            @Override
            public void run() {
                ChatDetailActivity_.super.onPostExecuteQuitQun(response);
            }
    ...
    @Override
    public void toNewMember(final ArrayList<String> extraUids) {
        handler_.post(new Runnable() {


            @Override
            public void run() {
                ChatDetailActivity_.super.toNewMember(extraUids);
            }
    ...
    @Override
    public void addNewMember(final List<Member> members) {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    ChatDetailActivity_.super.addNewMember(members);
                } catch (Throwable e) {
                    Thread.getDefaultUncaughtExceptionHandler().uncaughtException(Thread.currentThread(), e);
                }
            }
    ...
    @Override
    public void doInBackgroundQuitQun(final Member member) {
        BackgroundExecutor.execute(new BackgroundExecutor.Task("", 0, "") {
            ...
            public void execute() {
                try {
                    ChatDetailActivity_.super.doInBackgroundQuitQun(member);
                } catch (Throwable e) {
                    Thread.getDefaultUncaughtExceptionHandler().uncaughtException(Thread.currentThread(), e);
                }
            }
