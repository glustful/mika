    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public static FileListActivity_.IntentBuilder_ intent(android.app.Fragment fragment) {
        return new FileListActivity_.IntentBuilder_(fragment);
    }

    public static FileListActivity_.IntentBuilder_ intent(android.support.v4.app.Fragment supportFragment) {
        return new FileListActivity_.IntentBuilder_(supportFragment);
    }

    @Override
    public void onViewChanged(HasViews hasViews) {
        dirButton = ((Button) hasViews.findViewById(id.dirButton));
        headLayout = ((RelativeLayout) hasViews.findViewById(id.headView));
        cancelButton = ((Button) hasViews.findViewById(id.cancleButton));
        afterView();
    }
