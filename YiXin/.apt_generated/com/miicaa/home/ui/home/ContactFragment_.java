    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (contentView_ == null) {
            contentView_ = inflater.inflate(layout.contact_list_view, container, false);
        }
        return contentView_;
    }
    ...
    public void onViewChanged(HasViews hasViews) {
        mListView = ((ListView) hasViews.findViewById(com.miicaa.home.R.id.contact_list_view_list));
        contactIndexListView = ((ContactIndexListView) hasViews.findViewById(com.miicaa.home.R.id.contact_index_list));
    }
