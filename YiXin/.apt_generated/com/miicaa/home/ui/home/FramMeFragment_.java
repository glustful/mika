    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        ...
        {
            View view = hasViews.findViewById(com.miicaa.home.R.id.home_fram_me_head_view);
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        FramMeFragment_.this.headViewClick(view);
                    }
        ...
        }
        {
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        FramMeFragment_.this.editMeClick(view);
                    }
