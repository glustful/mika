...
public class DataPicker extends LinearLayout {
     ...
     * format().
     */
    private static class TwoDigitFormatter implements DataPicker.Formatter {
    ...
    public interface OnScrollListener {
         ...
         *            {@link #SCROLL_STATE_IDLE}.
         */
        public void onScrollStateChange(DataPicker view, int scrollState);
    }
	...
	public DataPicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        mInputText.setVisibility(View.INVISIBLE);//不使用edit
     ...
     * <p>
     * If the argument is less than the {@link DataPicker#getMinValue()} and
     * {@link DataPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link DataPicker#getMinValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link DataPicker#getMinValue()} and
     * {@link DataPicker#getWrapSelectorWheel()} is <code>true</code> the
     * current value is set to the {@link DataPicker#getMaxValue()} value.
     * </p>
     * <p>
     * If the argument is less than the {@link DataPicker#getMaxValue()} and
     * {@link DataPicker#getWrapSelectorWheel()} is <code>false</code> the
     * current value is set to the {@link DataPicker#getMaxValue()} value.
     * </p>
     * <p>
...
//                mInputText.setVisibility(View.VISIBLE);
     ...
     * wrap around the {@link DataPicker#getMinValue()} and
     * {@link DataPicker#getMaxValue()} values.
     * <p>
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < selectorIndices.length; i++) {
            ...
            Log.d("value", scrollSelectorValue);
//            if (i != SELECTOR_MIDDLE_ITEM_INDEX || mInputText.getVisibility() != VISIBLE) {
                canvas.drawText(textStr[Integer.parseInt(scrollSelectorValue)], x, y, mSelectorWheelPaint);
//            }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(DataPicker.class.getName());
    ...
    private boolean updateInputTextView() {
        ...
        if (!TextUtils.isEmpty(text) && !text.equals(mInputText.getText().toString()) && textStr != null) {
...
//            onDraw();
    ...
    class PressedStateHelper implements Runnable {
        ...
        public void cancel() {
            mMode = 0;
            mManagedButton = 0;
            DataPicker.this.removeCallbacks(this);
            if (mIncrementVirtualButtonPressed) {
        ...
        public void buttonPressDelayed(int button) {
            ...
            DataPicker.this.postDelayed(this, ViewConfiguration.getTapTimeout());
        }
            ...
            switch (mMode) {
                ...
                case MODE_TAPPED: {
                    switch (mManagedButton) {
                        case BUTTON_INCREMENT: {
                            if (!mIncrementVirtualButtonPressed) {
                                DataPicker.this.postDelayed(this,
	...
	class AccessibilityNodeProviderImpl extends AccessibilityNodeProvider {
            ...
            switch (virtualViewId) {
                ...
                case VIRTUAL_VIEW_ID_INPUT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_FOCUS: {
                            if (DataPicker.this.isEnabled() && !mInputText.isFocused()) {
                ...
                case VIRTUAL_VIEW_ID_INCREMENT: {
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (DataPicker.this.isEnabled()) {
                                DataPicker.this.changeValueByOne(true);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                    ...
                    switch (action) {
                        case AccessibilityNodeInfo.ACTION_CLICK: {
                            if (DataPicker.this.isEnabled()) {
                                ...
                                DataPicker.this.changeValueByOne(increment);
                                sendAccessibilityEventForVirtualView(virtualViewId,
                                        AccessibilityEvent.TYPE_VIEW_CLICKED);
                                return true;
                            }
        ...
        private void sendAccessibilityEventForVirtualText(int eventType) {
            if (((AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
                ...
                event.setSource(DataPicker.this, VIRTUAL_VIEW_ID_INPUT);
                requestSendAccessibilityEvent(DataPicker.this, event);
            }
        }
        ...
        private void sendAccessibilityEventForVirtualButton(int virtualViewId, int eventType,
            ...
            if (((AccessibilityManager) getContext().getSystemService(Context.ACCESSIBILITY_SERVICE)).isEnabled()) {
                ...
                event.setEnabled(DataPicker.this.isEnabled());
                event.setSource(DataPicker.this, virtualViewId);
                requestSendAccessibilityEvent(DataPicker.this, event);
            }
        }
        ...
        private AccessibilityNodeInfo createAccessibiltyNodeInfoForInputText() {
            ...
            info.setSource(DataPicker.this, VIRTUAL_VIEW_ID_INPUT);
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForVirtualButton(int virtualViewId,
            ...
            info.setSource(DataPicker.this, virtualViewId);
            info.setParent(DataPicker.this);
            info.setText(text);
            info.setClickable(true);
            info.setLongClickable(true);
            info.setEnabled(DataPicker.this.isEnabled());
        ...
        private AccessibilityNodeInfo createAccessibilityNodeInfoForNumberPicker(int left, int top,
            ...
            AccessibilityNodeInfo info = AccessibilityNodeInfo.obtain();
            info.setClassName(DataPicker.class.getName());
            info.setPackageName(getContext().getPackageName());
            info.setSource(DataPicker.this);

            if (hasVirtualDecrementButton()) {
                info.addChild(DataPicker.this, VIRTUAL_VIEW_ID_DECREMENT);
            }
            info.addChild(DataPicker.this, VIRTUAL_VIEW_ID_INPUT);
            if (hasVirtualIncrementButton()) {
                info.addChild(DataPicker.this, VIRTUAL_VIEW_ID_INCREMENT);
            }
