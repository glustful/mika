...
public class DatabaseHelper {
	...
	public Boolean openOrCreateDatabase(String dbPath) {
		try {
			...
			Debugger.d("DatabaseHelper", "DatabaseHelper openOrCreateDatabase failed: " + e.toString());
		}
		return false;
	}
	...
	public Boolean execSQL(String sql) {
		if (isOpen() && checkSql(sql)) {
			try {
				...
				Debugger.d("DatabaseHelper", "DatabaseHelper execSQL failed: " + e.toString());
			}
		}
		return false;
	}
	...
	public ArrayList<ContentValues> query(OnEachRow onEachRow, Object cbData, String sql, String... bindArgs) {
		...
		if (isOpen() && checkSql(sql)) {
			try {
				...
				Debugger.d("DatabaseHelper", "DatabaseHelper rawQuery failed: " + e.toString());
			}
		}
		return rs;
	}
