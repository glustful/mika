 ...
 */
public class BorwseRangeEdit extends Activity
{
    String mContent;
    Button mYesButton;
    Button mNoButton;
	...
	public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.borwse_range_activity);
    ...
    private void initUI()
    {
        Button button = (Button)findViewById(R.id.browse_range_id_back);
        button.setOnClickListener(onBackClick);

        mYesButton = (Button)findViewById(R.id.browse_range_id_public);
        mYesButton.setOnClickListener(onYesClick);
        mNoButton = (Button)findViewById(R.id.browse_range_id_person_range);
