...
public class PictureLoader
{
	...
	public static PictureLoader getInstance()
	{
		...
		if (mInstance == null)
		{
			synchronized (PictureLoader.class)
			{
				if (mInstance == null)
				{
					mInstance = new PictureLoader(1, Type.LIFO);
				}
			}
		}
		return mInstance;
	...
	private PictureLoader(int threadCount, Type type)
	{
	 ...
	 * @return
	 */
	public static PictureLoader getInstance(int threadCount, Type type)
	{
		...
		if (mInstance == null)
		{
			synchronized (PictureLoader.class)
			{
				if (mInstance == null)
				{
					mInstance = new PictureLoader(threadCount, type);
				}
			}
		}
		return mInstance;
