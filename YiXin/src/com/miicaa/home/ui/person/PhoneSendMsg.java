 ...
 */
public class PhoneSendMsg extends Activity
{
	...
	public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.person_phone_send_to_activity);
    ...
    private void initUI()
    {
        Button button = (Button)findViewById(R.id.send_to_id_back);
        button.setOnClickListener(onBackClick);

        mCallPhoneLayout = (LinearLayout)findViewById(R.id.send_to_id_call_phone_layout);
        mCallPhoneText = (TextView)findViewById(R.id.send_to_id_call_phone);
        mCallPhoneLayout.setOnClickListener(onCallPhoneClick);
        mCallPhoneText.setText(mCallPhoneNum);

        mPhoneLayout = (LinearLayout)findViewById(R.id.send_to_id_phone_layout);
        mPhoneText = (TextView)findViewById(R.id.send_to_id_phone);
    ...
    View.OnClickListener onCallPhoneClick = new View.OnClickListener()
    {
        ...
        public void onClick(View view)
        {
            Intent intent = new Intent(
                    Intent.ACTION_SENDTO, Uri.parse("smsto:"+mCallPhoneNum));
    ...
    View.OnClickListener onPhoneClick = new View.OnClickListener()
    {
        ...
        {
            Intent intent = new Intent(
                    Intent.ACTION_SENDTO, Uri.parse("smsto:"+mPhoneNum));
            startActivity(intent);
        }
    };
}