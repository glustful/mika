package com.yxst.epic.yixin.download;
...
public class DownloadService extends Service {
    ...
    public static DownloadManager getDownloadManager(Context appContext) {
        ...
        if (DownloadService.DOWNLOAD_MANAGER == null) {
            ...
            List<Message> dbMsgs = DBManager.getInstance(appContext).getMessagesVoiceNotDownloadSuccess(MyApplication.getInstance().getLocalUserName());
            if (dbMsgs != null) {
