...
public class WheelView extends ScrollView {
    ...
    public interface OnWheelViewListener {
        public void onSelected(int selectedIndex, PopupItem item) ;
...
//    private ScrollView scrollView;
    ...
    private List<PopupItem> getItems() {
        return items;
    }
...
//                    Logger.d(TAG, "remainder: " + remainder + ", divided: " + divided);
    ...
    private TextView createView(PopupItem item) {
        TextView tv = new TextView(context);
        tv.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
        tv.setSingleLine(true);
        tv.setTextSize(TypedValue.COMPLEX_UNIT_SP, 20);
        tv.setText(item.mContent);
...
//            position = divided + offset + 1;
    ...
    public PopupItem getSeletedItem() {
