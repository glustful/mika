...
public class ExtListView extends PullToRefreshAdapterViewBase<PinnedHeaderListView> {
	...
	// liuxue
	PinnedHeaderListView mRefreshableView;
	...
	public ExtListView(Context context, Mode mode) {
		super(context, mode);
	}

	public ExtListView(Context context, Mode mode, AnimationStyle style) {
	...
	final class InternalListViewSDK9 extends InternalListView {
		...
		protected boolean overScrollBy(int deltaX, int deltaY, int scrollX, int scrollY, int scrollRangeX,
			...
			OverscrollHelper.overScrollBy(ExtListView.this, deltaX, scrollX, deltaY, scrollY, isTouchEvent);
	...
	protected class InternalListView extends PinnedHeaderListView implements EmptyViewMethodAccessor {
		...
		public void setEmptyView(View emptyView) {
			ExtListView.this.setEmptyView(emptyView);
		}
