...
import com.yxtech.example.im.db.DaoSession;
...
<application> element:
    ...
    <provider
            android:name="com.yxtech.example.im.db.MessageContentProvider"
            android:authorities="com.yxtech.example.im.db.Message"/>
    */

    public class MessageContentProvider extends ContentProvider {

    public static final String AUTHORITY = "com.yxtech.example.im.db.Message";
